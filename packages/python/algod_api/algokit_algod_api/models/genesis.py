...
class Genesis(BaseModel):
    ...
    devmode: Optional[StrictBool] = None
    fees: StrictStr
    id: StrictStr
    network: StrictStr
    proto: StrictStr
    rwd: StrictStr
    timestamp: StrictInt
    __properties: ClassVar[List[str]] = ["alloc", "comment", "devmode", "fees", "id", "network", "proto", "rwd", "timestamp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in alloc (list)
        _items = []
        if self.alloc:
            for _item_alloc in self.alloc:
                if _item_alloc:
                    _items.append(_item_alloc.to_dict())
            _dict['alloc'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alloc": [GenesisAllocation.from_dict(_item) for _item in obj["alloc"]] if obj.get("alloc") is not None else None,
