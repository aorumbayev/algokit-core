...
class GenesisAllocation(BaseModel):
    """
    GenesisAllocation
    """ # noqa: E501
    addr: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["addr", "comment", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "state": GenesisAllocationState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
