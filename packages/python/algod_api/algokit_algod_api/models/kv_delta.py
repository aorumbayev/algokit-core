...
class KvDelta(BaseModel):
    """
    A single Delta containing the key, the previous value and the current value for a single round.
    """ # noqa: E501
    key: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, description="The key, base64 encoded.")
    value: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, description="The new value of the KV store entry, base64 encoded.")
