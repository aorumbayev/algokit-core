...
class GenesisAllocationState(BaseModel):
    """
    GenesisAllocationState
    """ # noqa: E501
    algo: StrictInt
    onl: Optional[StrictInt] = None
    sel: Optional[StrictStr] = None
    stprf: Optional[StrictStr] = None
    vote: Optional[StrictStr] = None
    vote_kd: Optional[StrictInt] = Field(default=None, alias="voteKD")
    vote_fst: Optional[StrictInt] = Field(default=None, alias="voteFst")
    vote_lst: Optional[StrictInt] = Field(default=None, alias="voteLst")
    __properties: ClassVar[List[str]] = ["algo", "onl", "sel", "stprf", "vote", "voteKD", "voteFst", "voteLst"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stprf": obj.get("stprf"),
            "vote": obj.get("vote"),
            "voteKD": obj.get("voteKD"),
            "voteFst": obj.get("voteFst"),
            "voteLst": obj.get("voteLst")
        })
        return _obj
